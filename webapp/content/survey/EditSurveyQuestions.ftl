      ...
      <table class="basic-table hover-bar" cellspacing="0">
        ...
        <#list surveyQuestionAndApplList as surveyQuestionAndAppl>
          ...
          <#else/>
            ...
            <form method="post" action="<@noerpUrl>updateSurveyQuestionAppl</@noerpUrl>">
              ...
              <td><a href="<@noerpUrl>EditSurveyQuestions?surveyId=${requestParameters.surveyId}&amp;surveyQuestionId=${surveyQuestionAndAppl.surveyQuestionId}#edit</@noerpUrl>" class="buttontext">${uiLabelMap.CommonEdit}&nbsp;${uiLabelMap.ContentSurveyQuestion}</a></td>
              </form>
              <td>
                <form id="removeSurveyQuestion_${surveyQuestionAndAppl.surveyQuestionId}" action="<@noerpUrl>removeSurveyQuestionAppl</@noerpUrl>" method="post">
                  <input type="hidden" name="surveyId" value="${surveyQuestionAndAppl.surveyId}" />
                  <input type="hidden" name="surveyQuestionId" value="${surveyQuestionAndAppl.surveyQuestionId}" />
                  <input type="hidden" name="fromDate" value="${surveyQuestionAndAppl.fromDate}" />
      ...
      <div class="screenlet-body">
        ...
        <table class="basic-table hover-bar" cellspacing="0">
          ...
          <#list categoryQuestions as question>
            ...
            <form method="post" action="<@noerpUrl>createSurveyQuestionAppl</@noerpUrl>">
              ...
              <tr<#if alt_row> class="alternate-row"</#if>>
                <td><a href="<@noerpUrl>EditSurveyQuestions?surveyId=${requestParameters.surveyId}&amp;surveyQuestionId=${question.surveyQuestionId}&amp;surveyQuestionCategoryId=${requestParameters.surveyQuestionCategoryId}#edit</@noerpUrl>" class="buttontext">${question.surveyQuestionId}</a></td>
...
<div class="screenlet">
  ...
  <div class="screenlet-body">
      <form method="post" action="<@noerpUrl>EditSurveyQuestions</@noerpUrl>">
        <input type="hidden" name="surveyId" value="${requestParameters.surveyId}"/>
...
<div class="screenlet">
  ...
  <#if requestParameters.newCategory?default("N") == "Y">
    ...
    <div class="screenlet-body">
      <a href="<@noerpUrl>EditSurveyQuestions?surveyId=${requestParameters.surveyId}</@noerpUrl>" class="buttontext">${uiLabelMap.CommonNew} ${uiLabelMap.ContentSurveyQuestion}</a>
      <br /><br />
  ...
  <#else>
    ...
    <a href="<@noerpUrl>EditSurveyQuestions?surveyId=${requestParameters.surveyId}&amp;newCategory=Y</@noerpUrl>" class="buttontext">${uiLabelMap.CommonNew} ${uiLabelMap.ContentSurveyQuestion} ${uiLabelMap.ContentSurveryCategory}</a>
    <br /><br />
    ...
    <table class="basic-table hover-bar" cellspacing="0">
      ...
      <#list questionOptions as option>
        <tr<#if alt_row> class="alternate-row"</#if>>
          ...
          <td><a href="<@noerpUrl>EditSurveyQuestions?surveyId=${requestParameters.surveyId}&amp;surveyQuestionId=${option.surveyQuestionId}&amp;surveyOptionSeqId=${option.surveyOptionSeqId}</@noerpUrl>" class="buttontext">${uiLabelMap.CommonEdit}</a></td>
          <td>
            <form id="deleteSurveyQuestionOption_${option_index}" action="<@noerpUrl>deleteSurveyQuestionOption</@noerpUrl>" method="post">
              <input type="hidden" name="surveyId" value="${requestParameters.surveyId}" />
...
<div class="screenlet">
    ...
    <div class="screenlet-body">
      <a href="<@noerpUrl>EditSurveyQuestions?surveyId=${requestParameters.surveyId}&amp;surveyQuestionId=${surveyQuestionOption.surveyQuestionId}</@noerpUrl>" class="buttontext">[${uiLabelMap.CommonNew} ${uiLabelMap.ContentSurveyOption}]</a>
    </#if>
