...
<table border="0" width='100%' cellspacing='0' cellpadding='0' class='boxoutside'>
  <tr>
    <td width='100%'>
      <form name="userform" method="post" action="<@noerpUrl>CMSSites</@noerpUrl>" >
  ...
  <tr>
    <td width='100%'>
      <table width='100%' border='0' cellspacing='0' cellpadding='0' class='boxbottom'>
        <tr>
          <td>
            <form method="post" name="publishsite" action="<@noerpUrl>linkContentToPubPt</@noerpUrl>">
        ...
        <tr>
         <td >
            <a class="buttontext" href="<@noerpUrl>addSubSite?rootForumId=${rootForumId}&amp;parentForumId=${rootForumId}</@noerpUrl>" >Add Top Level Forum</a>
         </td >
        </tr>
...
<@loopSubContent contentId=forumId viewIndex=0 viewSize=9999 contentAssocTypeId="SUBSITE" returnAfterPickWhen="1==1";>
       <tr>
         ...
         <td >
            <a class="buttontext" href="<@noerpUrl>CMSSites?rootForumId=${rootForumId}&amp;moderatedSiteId=${content.contentId}</@noerpUrl>">Moderate</a>
         </td >
         <td >&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; </td >
         <td >
            <a class="buttontext" href="<@noerpUrl>CMSSites?rootForumId=${rootForumId}&amp;permRoleSiteId=${content.contentId}</@noerpUrl>">User Roles</a>
         </td >
         <td >&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; </td >
         <td >
            <a class="buttontext" href="<@noerpUrl>addSubSite?rootForumId=${rootForumId}&amp;parentForumId=${content.contentId}</@noerpUrl>" >Add Child Forum</a>
         </td >
         <td >&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; </td >
         <td >
            <a class="buttontext" href="<@noerpUrl>removeSite?rootForumId=${rootForumId}&amp;contentId=${content.contentId}&amp;contentIdTo=${forumId}&amp;contentAssocTypeId=SUBSITE</@noerpUrl>">RemoveSite</a>
         </td >
       </tr>
...
<table width="100%" border="0" >
 <form name="mostrecent" method="post" action="<@noerpUrl>publishResponse</@noerpUrl>"/>
  <#assign row=0/>
  <#list mostRecentList as content>
    <@checkPermission entityOperation="_ADMIN" targetOperation="CONTENT_PUBLISH" subContentId=forumId >
      ...
      <@injectNodeTrailCsv subContentId=content.contentId redo="true" contentAssocTypeId="PUBLISH_LINK">
          <td>
  <a class="tabButton" href="<@noerpUrl>CMSContentEdit?contentId=${content.contentId}&amp;nodeTrailCsv=${nodeTrailCsv!}</@noerpUrl>" >View</a>
          </td>
          <td>
          <b>submitted:</b>
...
<table width="100%" border="0" >
  <tr>
    <td width='100%'>
      <form name="siteRoleForm" method="post" action="<@noerpUrl>updateSiteRoles</@noerpUrl>">
      ...
      <#assign rowCount=0/>
        <#list siteList as siteRoleMap>
          <tr>
            ...
            <#list blogRoleIdList as roleTypeId>
              <#assign cappedSiteRole= Static["org.noerp.entity.model.ModelUtil"].dbNameToVarName(roleTypeId) />
              <td align="center">
