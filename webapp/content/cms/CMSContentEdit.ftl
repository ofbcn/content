  ...
  <tr>
    <td width='100%'>
      <table width='100%' border='0' cellspacing='0' cellpadding='0' class='boxbottom'>
        <tr>
          <td>
            <form mode="post" name="publishsite" action="<@noerpUrl>linkContentToPubPt</@noerpUrl>">
  ...
  <tr>
    <td width='100%'>
      <table width='100%' border='0' cellspacing='0' cellpadding='0' class='boxbottom'>
        <tr>
          <td>
            <form mode="post" name="updatefeatures" action="<@noerpUrl>updateFeatures</@noerpUrl>">
              <input type="hidden" name="contentId" value="${contentId}"/>
              <table width="100%" border="0" cellpadding="1">
                       <tr>
...
<table border="0" width='100%' cellspacing='0' cellpadding='0' class='boxoutside'>
      ...
      <table width='100%' border='0' cellspacing='0' cellpadding='0' class='boxtop'>
        <tr>
          ...
          <td valign="middle" align="right">
            <a href="<@noerpUrl>EditAddImage?contentId=${imgContentId!}dataResourceId=${imgDataResourceId!}</@noerpUrl>" class="submenutextright">Update</a>
          </td>
        </tr>
      </table>
    </td>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing='0'>
    <tr><td align="right" nowrap="nowrap"><div class='tabletext'><b>Image</b></div></td><td>&nbsp;</td><td><div class='tabletext'>
        <img src="<@noerpUrl>img?imgId=${imgDataResourceId!}</@noerpUrl>" alt="" />
<div></td></tr>
  </table>
          </td>
        </tr>
    ...
    <td width='100%'>
      <table width='100%' border='0' cellspacing='0' cellpadding='0' class='boxtop'>
        <tr>
          ...
          <td valign="middle" align="right">
            <a href="<@noerpUrl>EditAddContent?contentId=${content.contentId!}&amp;contentIdTo=${content.caContentIdTo!}&amp;contentAssocTypeId=${content.caContentAssocTypeId!}&amp;fromDate=${content.caFromDate!}&amp;mapKey=${content.caMapKey!}</@noerpUrl>" class="submenutextright">Update</a>
          </td>
        </tr>
      </table>
    </td>
