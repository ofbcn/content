...
<script type="text/javascript">
    ...
    function cmsSave() {
        var simpleFormAction = '<@noerpUrl>/updateContentCms</@noerpUrl>';
...
<#-- main content form -->
<#if (dataResourceTypeId?has_content)>
    <form name="cmsform" enctype="multipart/form-data" method="post" action="<@noerpUrl>${formAction}</@noerpUrl>" style="margin: 0;">
        <#if (content?has_content)>
