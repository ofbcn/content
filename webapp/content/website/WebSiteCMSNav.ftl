...
<script language="javascript" type="text/javascript" src="<@noerpContentUrl>/assets/jquery/plugins/elrte-1.3/js/elrte.min.js</@noerpContentUrl>"></script>
<#if language?has_content && language != "en">
<script language="javascript" src="<@noerpContentUrl>/assets/jquery/plugins/elrte-1.3/js/i18n/elrte.${language!"en"}.js</@noerpContentUrl>" type="text/javascript"></script><#rt/>
</#if>
...
<script type="text/javascript">
    ...
    var editorUrl = '<@noerpUrl>/views/WebSiteCMSContent</@noerpUrl>';
    var aliasUrl = '<@noerpUrl>/views/WebSiteCMSPathAlias</@noerpUrl>';
    var metaUrl = '<@noerpUrl>/views/WebSiteCMSMetaInfo</@noerpUrl>';
...
<#-------------------------------------------------------------------------------------pathRemove function-->
    function pathRemove(websiteId, pathAlias, contentId) {
        var remAliasUrl = '<@noerpUrl>/removeWebSitePathAliasJson</@noerpUrl>';
