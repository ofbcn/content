...
var rawdata = [
      ...
      <#macro fillTree assocList>
          <#if (assocList?has_content)>
            <#list assocList as assoc>
                ...
                <#assign assocChilds  = delegator.findByAnd("ContentAssoc",Static["org.noerp.base.util.UtilMisc"].toMap("contentId",assoc.contentIdTo,"contentAssocTypeId", "TREE_CHILD"), Static["org.noerp.base.util.UtilMisc"].toList("sequenceNum"), false)/>
 ...
 <#-------------------------------------------------------------------------------------define Requests-->
    ...
    var listDocument =  '<@noerpUrl>/views/ShowDocument</@noerpUrl>';
