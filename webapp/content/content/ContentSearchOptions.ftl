...
<div class="screenlet">
  ...
  <div class="screenlet-body">
    <form name="advToKeyWordSearchForm" method="post" action="<@noerpUrl>ContentSearchResults</@noerpUrl>" style="margin: 0;">
      ...
      <table class="basic-table" cellspacing="0">
        ...
        <input type="image" src="<@noerpContentUrl>/assets/spacer.gif</@noerpContentUrl>" onclick="javascript:document.advToKeyWordSearchForm.submit();"/>
    </form>
  </div>
</div>
