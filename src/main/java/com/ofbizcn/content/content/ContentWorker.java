...
import org.noerp.widget.content.ContentWorkerInterface;
    ...
    public static void checkConditions(Delegator delegator, Map<String, Object> trailNode, Map<String, Object> contentAssoc, Map<String, Object> whenMap) {
        ...
        if (contentAssoc == null && content != null && (content.getEntityName().indexOf("Assoc") >= 0)) {
            ...
            try {
                ...
                SimpleMapProcessor.runSimpleMapProcessor("component://content/script/com/ofbizcn/content/ContentManagementMapProcessors.xml", "contentAssocIn", content, contentAssoc, FastList.newInstance(), Locale.getDefault());
